...
public class EmployeeUpdateAction implements Action{
	private static EmployeeUpdateAction employeeUpdateAction;
	static{
		employeeUpdateAction=new EmployeeUpdateAction();
	}
	
	public static EmployeeUpdateAction getEmployeeUpdateAction() {
		return employeeUpdateAction;
	}
	private EmployeeUpdateAction(){
	...
	public String action(HttpServletRequest request, HttpServletResponse response)
		...
		int result=AdminCompanyinfoEmployeeDaoImpl.getAdminCompanyinfoEmployeeDao().empupdate(employeesListDto);
		String url="";
		if(result==2){
