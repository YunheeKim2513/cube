...
public class MyWorkreportWriteAction implements Action {

	private static MyWorkreportWriteAction myWorkreportWriteAction;
	
	static {
		myWorkreportWriteAction = new MyWorkreportWriteAction();
	}
	
	private MyWorkreportWriteAction(){}
	
	public static MyWorkreportWriteAction getMyWorkreportWriteAction() {
	...
	public String action(HttpServletRequest request, HttpServletResponse response)
		...
		if("userworkupdate".equals(act)){
			work_reportDto.setDoc_seq(request.getParameter("docseq"));
			MyWorkreportUserServiceImpl.getMyWorkreportUserService().workupdate(work_reportDto);
		} else {
		...
		return "/pages/user_workreport/workreport_usermyworkreportview.jsp?docview=workreport";
	}
}
