...
<%
List<EmployeesListDto> list=(List<EmployeesListDto>)request.getAttribute("firelist");
%>
<!DOCTYPE html>
<html lang="en">
...
<body>
<form id="fForm" name="fForm" method="get" value="">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="even gradeC" id="<%=list.get(i).getEmployee_id() %>">
                                        ...
                                        <td><%=list.get(i).getGroup_standard() %></td>
                                    	...
                                    	<td><input type="button" onclick="javascript:fireupdate(this);" id="update" value="수 정">
                                    		<input type="button" onclick="javascript:firedelete(this);" id="delete" value="삭 제"></td>
                                    </tr>
                                    <%
                                    	}
                                    } else {%>
	...
	function fireupdate(obj){
		//alert(obj.parentNode.parentNode.id);
		var tr_id=obj.parentNode.parentNode.id
		document.getElementById("act").value = "mvfireupdate";
		document.getElementById("id").value = tr_id;
		document.fForm.action = "<%=root%>/emp";
		document.fForm.submit();
