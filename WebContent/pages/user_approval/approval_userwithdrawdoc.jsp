...
<% 
List<Doc_info_detailDto> withdrawdoclist = (List<Doc_info_detailDto>) request.getAttribute("withdrawdoclist");
%>
        <!-- /#page-wrapper -->
               <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">올린 결재 문서함 > 결재 완료</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover"  id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <%
                                    	for(Doc_info_detailDto doc_info_detailDto : withdrawdoclist){
                                    %><tr class="odd gradeX">
                                        ...
                                        <td onclick="javascript:viewarticle('<%=doc_info_detailDto.getDoc_seq() %>','<%=doc_info_detailDto.getDoc_name() %>');"><%=doc_info_detailDto.getConfirmokdate() %></td>
                                        <td onclick="javascript:viewarticle('<%=doc_info_detailDto.getDoc_seq() %>','<%=doc_info_detailDto.getDoc_name() %>');"><%=doc_info_detailDto.getConfirm_state() %></td>
                                        ...
                                        <td onclick="javascript:viewarticle('<%=doc_info_detailDto.getDoc_seq() %>','<%=doc_info_detailDto.getDoc_name() %>');"><%=doc_info_detailDto.getConfirmname() %></td>
...
<!-- jQuery -->
    ...
    function viewarticle(seq,dockind){
    	document.location.href="<%=root%>/userreportdoc?act=allviewarticle&seq="+seq+"&dockind="+encodeURI(dockind)+"&docview=userwithdrawdoc";
    }
    </script>
