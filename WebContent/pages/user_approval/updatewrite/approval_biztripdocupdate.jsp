...
%>
        ...
        <input type="hidden" id="act" name="act" value="biztripupdate">
        <input type="hidden" name="dockind" value="출장신청서">
        <input type="hidden" id="docseq" name="docseq" value="<%=biztripdocDto.getDoc_seq() %>">
        <!-- /#page-wrapper -->
               <div id="page-wrapper">
            <div class="row">
				<div class="col-lg-12">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                <thead>
					              ...
					              <tr>
					                <th>문서상태</th>
					                <td>
					                  <label><%=biztripdocDto.getDoc_state() %></label>
					                </td>
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                  <label><%=employeesDto.getGarde_name()%><br><%=employeesDto.getName()%></label>
					                </td>
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="biztripconfirmname0" name="biztripconfirmname0" value="" text=""><%=biztripdocDto.getConfirmlistname1() %></div>
					                <input type="text" id="biztripconfirm0" name="biztripconfirm0" value="<%=biztripdocDto.getConfirmlist1() %>" style="display:none;">
					                <input type="text" id="biztripconfirms0" name="biztripconfirms0" value="<%=biztripdocDto.getConfirmlistname1() %>" style="display:none;">
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="biztripconfirmname1" name="biztripconfirmname1" value="" text=""><%=biztripdocDto.getConfirmlistname2() %></div>
					                <input type="text" id="biztripconfirm1" name="biztripconfirm1" value="<%=biztripdocDto.getConfirmlist2() %>" style="display:none;">
					                <input type="text" id="biztripconfirms1" name="biztripconfirms1" value="<%=biztripdocDto.getConfirmlistname2() %>" style="display:none;">
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="biztripconfirmname2" name="biztripconfirmname2" value="" text=""><%=biztripdocDto.getConfirmlistname3() %></div>
					                <input type="text" id="biztripconfirm2" name="biztripconfirm2" value="<%=biztripdocDto.getConfirmlist3() %>" style="display:none;">
					                <input type="text" id="biztripconfirms2" name="biztripconfirms2" value="<%=biztripdocDto.getConfirmlistname3() %>" style="display:none;">
					              ...
					              <tr>
					                ...
					                <td colspan="6">
										...
										<span class="col-lg-4" style="margin-left:-16px">
										      <form class="demo-3">
										        <input type='text' id="dayinputtext" name="dayinputtext" value="<%=biztripdocDto.getDoc_date() %>" class="form-control" style="width:50%; text-align:center">
										      </form>
										</span>
										<input type='text' id="daytext" name="daytext" value="<%=biztripdocDto.getDoc_date() %>" class="form-control" style="width:50%; display:none">
					                </td>
					              </tr>
					              <tr>
					                <th>수신부서</th>
					                <td colspan="6">
					                  <input id="receiveinputbox" name="receiveinputbox" value="<%=biztripdocDto.getDoc_receiver() %>" class="form-controltext" readonly="readonly">&nbsp;&nbsp;&nbsp;&nbsp;
					              ...
					              <tr>
					                <th>참조부서</th>
					                <td colspan="6">
					                  <input id="referenceinputbox" name="referenceinputbox" class="form-controltext" value="<%=biztripdocDto.getDoc_reference() %>" readonly="readonly">&nbsp;&nbsp;&nbsp;&nbsp;
					                  <!-- Button trigger modal -->
					            ...
					            <!--  <tr>
					              ...
					              <tr>
					                <th>제목</th>
					                <td colspan="6">
					                  <input class="form-controltext" id="biztripsubject" name="biztripsubject" value="<%=biztripdocDto.getDoc_subject() %>">
					                </td>
					              </tr>
					              <tr>
					              	<tbody>
					              		<tr>
					              			...
					              			<td colspan="6">
						              			<span class="col-lg-4" style="margin-left:-16px">
											      <form class="demo-3">
											        <input type='text' id="biztripinputtext1" name="biztripinputtext1" value="<%=biztripdocDto.getBiztripdoc_start() %>" class="form-control" style="width:80%; text-align:center">
											      </form>  
											    </span>
											    <span class="col-lg-4" style="margin-left:-16px">  
											      <form class="demo-3">
											        <input type='text' id="biztripinputtext2" name="biztripinputtext2" value="<%=biztripdocDto.getBiztripdoc_end() %>" class="form-control" style="width:80%; text-align:center">
											      </form>
												</span>
												<input type='text' id="biztripstart" name="biztripstart" value="<%=biztripdocDto.getBiztripdoc_start() %>" class="form-control" style="width:50%; display:none">
												<input type='text' id="biztripend" name="biztripend" value="<%=biztripdocDto.getBiztripdoc_end() %>" class="form-control" style="width:50%; display:none">
												<!-- (현재 사용한 연차는 '0일',잔여 연차는 '10일'입니다.) -->
					              			</td>
					              		</tr>
					              		<tr>
					              			<th>출장지</th>
					              			<td colspan="6"><input type="text" class="form-controltext" id="route" name="route" value="<%=biztripdocDto.getBiztripdoc_route()%>"></td>
					              		</tr>
					              		<tr>
					              			<th>출장목적</th>
					              			<td colspan="6">
					              			<!-- <input type="text" class="form-controltext" id="content" name="content" value=""> -->
					              				<textarea class="form-control" rows="3" id="content" name="content" value=""><%=biztripdocDto.getBiztripdoc_content()%></textarea>
					              			</td>
					              		</tr>
				              		</tbody>
                            </table>
