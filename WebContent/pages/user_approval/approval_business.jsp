...
<% 
List<Doc_info_detailDto> bapprovallist = (List<Doc_info_detailDto>) request.getAttribute("bapprovallist");
%>
        <!-- /#page-wrapper -->
               <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">회사 전체 문서</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<!-- jQuery -->
    ...
    function viewarticle(seq,dockind){
    	document.location.href="<%=root%>/userreportdoc?act=allviewarticle&seq="+seq+"&dockind="+encodeURI(dockind)+"&docview=business";
    }
    </script>
