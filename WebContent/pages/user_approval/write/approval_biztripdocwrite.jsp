...
%>
        ...
        <input type="hidden" id="act" name="act" value="biztripregistor">
        <input type="hidden" name="dockind" value="출장신청서">
        <!-- /#page-wrapper -->
               <div id="page-wrapper">
            <div class="row">
				<div class="col-lg-12">
                    	<h1 class="page-header">출장신청서</h1>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                <thead>
					              ...
					              <tr>
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="biztripconfirmname0" name="biztripconfirmname0" value="" text=""></div>
					                <input type="text" id="biztripconfirm0" name="biztripconfirm0" value="" style="display:none;">
					                <input type="text" id="biztripconfirms0" name="biztripconfirms0" value="" style="display:none;">
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="biztripconfirmname1" name="biztripconfirmname1" value="" text=""></div>
					                <input type="text" id="biztripconfirm1" name="biztripconfirm1" value="" style="display:none;">
					                <input type="text" id="biztripconfirms1" name="biztripconfirms1" value="" style="display:none;">
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="biztripconfirmname2" name="biztripconfirmname2" value="" text=""></div>
					                <input type="text" id="biztripconfirm2" name="biztripconfirm2" value="" style="display:none;">
					                <input type="text" id="biztripconfirms2" name="biztripconfirms2" value="" style="display:none;">
					              ...
					              <tr>
					                <th>제목</th>
					                <td colspan="6">
					                  <input class="form-controltext" id="biztripsubject" name="biztripsubject" value="">
					                </td>
					              </tr>
					              <tr>
					              	<tbody>
					              		<tr>
					              			...
					              			<td colspan="6">
						              			<span class="col-lg-4" style="margin-left:-16px">
											      <form class="demo-3">
											        <input type='text' id="biztripinputtext1" name="biztripinputtext1" value="" class="form-control" style="width:80%; text-align:center">
											      </form>  
											    </span>
											    <span class="col-lg-4" style="margin-left:-16px">  
											      <form class="demo-3">
											        <input type='text' id="biztripinputtext2" name="biztripinputtext2" value="" class="form-control" style="width:80%; text-align:center">
											      </form>
												</span>
												<input type='text' id="biztripstart" name="biztripstart" value="" class="form-control" style="width:50%; display:none">
												<input type='text' id="biztripend" name="biztripend" value="" class="form-control" style="width:50%; display:none">
	...
	$("#registorok").click(function () {
		 if(!$("#biztripconfirmname0").text()){
				...
				document.biztripForm.action="<%=root%>/userdocwrite";				
				$("#biztripForm").submit();
			} else {
				return;
			}
