...
%>
        ...
        <input type="hidden" id="act" name="act" value="orderregistor">
               <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    	<h1 class="page-header">품의서</h1>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                <thead>
					              ...
					              <tr>
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="orderconfirmname0" name="orderconfirmname0" value="" text=""></div>
					                <input type="text" id="orderconfirm0" name="orderconfirm0" value="" style="display:none;">
					                <input type="text" id="orderconfirms0" name="orderconfirms0" value="" style="display:none;">
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="orderconfirmname1" name="orderconfirmname1" value="" text=""></div>
					                <input type="text" id="orderconfirm1" name="orderconfirm1" value="" style="display:none;">
					                <input type="text" id="orderconfirms1" name="orderconfirms1" value="" style="display:none;">
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="orderconfirmname2" name="orderconfirmname2" value="" text=""></div>
					                <input type="text" id="orderconfirm2" name="orderconfirm2" value="" style="display:none;">
					                <input type="text" id="orderconfirms2" name="orderconfirms2" value="" style="display:none;">
					              ...
					              <tr>
					                <th>제목</th>
					                <td colspan="6">
					                  <input class="form-controltext" id="ordersubject" name="ordersubject" value="">
					                </td>
					              </tr>
					              <tr>
					                <th colspan="7">
		...
		$("#registorok").click(function () {
			oEditors.getById["ir1"].exec("UPDATE_CONTENTS_FIELD", []);	// 에디터의 내용이 textarea에 적용됩니다.
			 ...
			 if(!$("#orderconfirmname0").text()){
					...
					document.orderForm.action="<%=root%>/userdocwrite";
					$("#orderForm").submit();
				} else {
					return;
				}
