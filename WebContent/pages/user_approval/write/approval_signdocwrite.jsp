...
%>
        ...
        <input type="hidden" id="act" name="act" value="signregistor">
        <input type="hidden" name="dockind" value="기안서">
               <div id="page-wrapper">
            <div class="row">
				<div class="col-lg-12">
                    	<h1 class="page-header">기안서</h1>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                <thead>
					              ...
					              <tr>
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="signconfirmname0" name="signconfirmname0" value="" text=""></div>
					                <input type="text" id="signconfirm0" name="signconfirm0" value="" style="display:none;">
					                <input type="text" id="signconfirms0" name="signconfirms0" value="" style="display:none;">
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="signconfirmname1" name="signconfirmname1" value="" text=""></div>
					                <input type="text" id="signconfirm1" name="signconfirm1" value="" style="display:none;">
					                <input type="text" id="signconfirms1" name="signconfirms1" value="" style="display:none;">
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="signconfirmname2" name="signconfirmname2" value="" text=""></div>
					                <input type="text" id="signconfirm2" name="signconfirm2" value="" style="display:none;">
					                <input type="text" id="signconfirms2" name="signconfirms2" value="" style="display:none;">
					             ...
					             <!--  <tr>
					                ...
					                <td colspan="6" >
					                  <script type="text/javascript" src="http://code.jquery.com/jquery-2.1.0.min.js"></script>
										<script>
										jQuery(function() {
											jQuery("#signfilename").on('change', function(){
												var thumbext = document.getElementById('signfilename').value//파일을 추가한 input 박스의 값
												thumbext = thumbext.slice(thumbext.indexOf(".") + 1).toLowerCase();//파일 확장자를 잘라내고, 비교를 위해 소문자로 만듭니다.
												if(thumbext == "exe" || thumbext == "msi" ||  thumbext == "bat" ||  thumbext == "vbs"){ //확장자를 확인합니다.
													alert('실행파일은 올릴 수 없습니다.');
										...
										<input type="file" name="signfilename" id="signfilename" style="width: 98%; display: block;" class="input" >
					                </td>
					              </tr> -->
					              <tr>
					                <th>제목</th>
					                <td colspan="6">
					                  <input class="form-controltext" id="signsubject" name="signsubject" value="">
					                </td>
					              </tr>
					              <tr>
					                <th colspan="7">
		...
		$("#registorok").click(function () {
			oEditors.getById["ir1"].exec("UPDATE_CONTENTS_FIELD", []);	// 에디터의 내용이 textarea에 적용됩니다.
			 ...
			 if(!$("#signconfirmname0").text()){
					...
					document.signForm.action="<%=root%>/userdocwrite";
					$("#signForm").submit();
				} else {
					return;
				}
