...
%>
        ...
        <input type="hidden" id="act" name="act" value="vacregistor">
        <input type="hidden" name="dockind" value="휴가계">
        <!-- /#page-wrapper -->
               <div id="page-wrapper">
            <div class="row">
				<div class="col-lg-12">
                    	<h1 class="page-header">휴가계</h1>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                <thead>
					              ...
					              <tr>
					                ...
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="vacconfirmname0" name="vacconfirmname0" value="" text=""></div>
					                <input type="text" id="vacconfirm0" name="vacconfirm0" value="" style="display:none;">
					                <input type="text" id="vacconfirms0" name="vacconfirms0" value="" style="display:none;">
					                  <span><button type="button" class="btn btn-primary btn-lg" id="vacdoc_approval0" value="appoint" onclick="javascript:test(this.value, this.id);" style="width:60px; height:35px; padding-top: 7px;" data-toggle="modal" data-target="#confirmemployee">지정</button></span>
					                </td>
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="vacconfirmname1" name="vacconfirmname1" value="" text=""></div>
					                <input type="text" id="vacconfirm1" name="vacconfirm1" value="" style="display:none;">
					                <input type="text" id="vacconfirms1" name="vacconfirms1" value="" style="display:none;">
					                  <span><button type="button" class="btn btn-primary btn-lg" id="vacdoc_approval1" value="appoint" onclick="javascript:test(this.value, this.id);" style="width:60px; height:35px; padding-top: 7px;" data-toggle="modal" data-target="#confirmemployee">지정</button></span>
					                </td>
					                <td rowspan="3" style="text-align:center; vertical-align:middle">
					                <div id="vacconfirmname2" name="vacconfirmname2" value="" text=""></div>
					                <input type="text" id="vacconfirm2" name="vacconfirm2" value="" style="display:none;">
					                <input type="text" id="vacconfirms2" name="vacconfirms2" value="" style="display:none;">
					                  <span><button type="button" class="btn btn-primary btn-lg" id="vacdoc_approval2" value="appoint" onclick="javascript:test(this.value, this.id);" style="width:60px; height:35px; padding-top: 7px;" data-toggle="modal" data-target="#confirmemployee">지정</button></span>
					                </td>
					                <!-- Modal -->
					              ...
					              <tr>
					                <th>수신부서</th>
					                <td colspan="6">
					                  <input id="receiveinputbox" name="receiveinputbox" value="" class="form-controltext" readonly="readonly">&nbsp;&nbsp;&nbsp;&nbsp;
					              ...
					              <tr>
					                <th>제목</th>
					                <td colspan="6">
					                  <input class="form-controltext" id="vacsubject" name="vacsubject" value="">
					                </td>
					              </tr>
					              <tr>
					              	<tbody>
					              		<tr>
					              			...
					              			<td colspan="6">
						              			<span class="col-lg-4" style="margin-left:-16px">
											      <form class="demo-3">
											        <input type='text' id="vacinputtext1" name="vacinputtext1" value="" class="form-control" style="width:80%; text-align:center">
											      </form>  
											    </span>
											    <span class="col-lg-4" style="margin-left:-16px">  
											      <form class="demo-3">
											        <input type='text' id="vacinputtext2" name="vacinputtext2" value="" class="form-control" style="width:80%; text-align:center">
											      </form>
												</span>
												<input type='text' id="vacstart" name="vacstart" value="" class="form-control" style="width:50%; display:none">
												<input type='text' id="vacend" name="vacend" value="" class="form-control" style="width:50%; display:none">
					              		...
					              		<tr>
					              			<th>행선지</th>
					              			<td colspan="6"><input type="text" class="form-controltext" id="route" name="route" value=""></td>
					              		</tr>
					              		<tr>
					              			<th>사유</th>
					              			<td colspan="6">
	...
	$("#registorok").click(function () {
		 if(!$("#vacconfirmname0").text()){
				...
				document.vacForm.action="<%=root%>/userdocwrite";				
				$("#vacForm").submit();
			} else {
				return;
			}
