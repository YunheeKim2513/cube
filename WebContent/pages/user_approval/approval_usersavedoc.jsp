...
<% 
List<Doc_info_detailDto> savedoclist = (List<Doc_info_detailDto>) request.getAttribute("savedoclist");
%>
        <!-- /#page-wrapper -->
               <div id="page-wrapper">
            <div class="row">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover"  id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <%
                                    	for(Doc_info_detailDto doc_info_detailDto : savedoclist){
                                    %><tr class="odd gradeX">
                                        ...
                                        <td onclick="javascript:viewarticle('<%=doc_info_detailDto.getDoc_seq() %>','<%=doc_info_detailDto.getDoc_name() %>');"><%=doc_info_detailDto.getDoc_writetime() %></td>
...
<!-- jQuery -->
    ...
    function viewarticle(seq,dockind){
    	document.location.href="<%=root%>/userreportdoc?act=tempviewarticle&seq="+seq+"&dockind="+encodeURI(dockind)+"&docview=usersavedoc";
    }
    </script>
