...
<% 
List<Doc_info_detailDto> reportlist = (List<Doc_info_detailDto>) request.getAttribute("reportlist");
%>
        <!-- /#page-wrapper -->
               <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">올린 결재 문서함 > 상신 문서</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover"  id="dataTables-example">
                               <thead>
                                ...
                                <tbody>
                                    ...
                                    <%
                                    	for(Doc_info_detailDto doc_info_detailDto : reportlist){
                                    %><tr>
...
<!-- jQuery -->
    ...
    function viewarticle(seq,dockind){
    	document.location.href="<%=root%>/userreportdoc?act=reportviewarticle&seq="+seq+"&dockind="+encodeURI(dockind)+"&docview=userreport";
    }
    </script>
