...
<% 
List<Doc_info_detailDto> depapprovallist = (List<Doc_info_detailDto>) request.getAttribute("depapprovallist");
%>
        <!-- /#page-wrapper -->
               <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">부서 전체 문서</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover"  id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <%
                                    	for(Doc_info_detailDto doc_info_detailDto : depapprovallist){
                                    %><tr class="odd gradeX">
...
<!-- jQuery -->
    ...
    function viewarticle(seq,dockind){
    	document.location.href="<%=root%>/userreportdoc?act=allviewarticle&seq="+seq+"&dockind="+encodeURI(dockind)+"&docview=department";
    }
    </script>
