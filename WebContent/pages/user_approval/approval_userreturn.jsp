...
<% 
List<Doc_info_detailDto> returndoclist = (List<Doc_info_detailDto>) request.getAttribute("returndoclist");
%>
        <!-- /#page-wrapper -->
               <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">올린 결재 문서함 > 회수 문서</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover"  id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <%
                                    	for(Doc_info_detailDto doc_info_detailDto : returndoclist){
                                    %><tr class="odd gradeX">
