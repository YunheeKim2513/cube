...
%>
        <!-- /#page-wrapper -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">내 업무보고 > 올린 업무보고 확인</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover"  id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    %><tr class="odd gradeX">
                                        ...
                                        <td onclick="javascript:viewarticle('<%=work_reportDto.getDoc_seq() %>','<%=work_reportDto.getDoc_name() %>');"><%=work_reportDto.getConfirmlist() %></td>
                                        <td onclick="javascript:viewarticle('<%=work_reportDto.getDoc_seq() %>','<%=work_reportDto.getDoc_name() %>');"><%=work_reportDto.getDoc_state() %></td>
...
<!-- jQuery -->
    ...
    function viewarticle(seq,dockind){
    	document.location.href="<%=root%>/userreportdoc?act=tempviewarticle&seq="+seq+"&dockind="+encodeURI(dockind)+"&docview=workreport";
    }
    </script>
