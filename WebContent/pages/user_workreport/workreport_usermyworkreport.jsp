            ...
            <div class="row">
				<div class="col-lg-12">
                    	...
                    	<div style="text-align:right">
                    		<span><button type="button" class="btn btn-primary" id="worksubmit">보고하기</button></span>
                                ...
                                <thead>
                                 <tr>
			              			...
			              			<label class="radio-inline">
                                        <input type="radio" name="workreportkind" id="dayreport" value="일일 업무 보고" checked>일일 업무 보고
                                    </label>
                                    <label class="radio-inline">
				              	  ...
				              	  <tr>
			              			...
			              			<td>
	                                    <label class="radio-inline">
	                                        <input type="radio" name="workviewkind" id="allview" value="전체공개" checked>전체공개
	                                    </label>
	                                    <label class="radio-inline">
