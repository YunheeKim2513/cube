...
<% NoticeDto noticeupdate = (NoticeDto) request.getAttribute("noticeupdate"); %>
        <!-- /#page-wrapper -->
        <form name ="helpForm" id="helpForm" method="post" action="">
        <input type="hidden" id="act" name="act" value="userhelpupdate">
        <input type="hidden" id="seq" name="seq" value="<%=noticeupdate.getNotice_seq()%>">
               <div id="page-wrapper">
            <div class="row">
				<div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                <thead>
					              <tr>
					                <th>글번호</th>
					                <td colspan="2"><%=noticeupdate.getNotice_seq() %></td>
					              </tr>
					              <tr>
					                <th>문서상태</th>
					                <td colspan="2">
					                  <label><%=noticeupdate.getNotice_state() %></label>
					                </td>
					              </tr>
					              <tr>
					                <th>부서</th>
					              ...
					              <tr>
					                <th>작성자</th>
					                <td colspan="2"><label><%=noticeupdate.getNotic_writer() %></label></td>
					              </tr>
					              <tr>
					                <th>작성일</th>
					                <td colspan="2"><%=noticeupdate.getNotice_date() %></td>
					              </tr>
					              <tr>
					                <th>처리 완료일</th>
					                <td colspan="2"><%=noticeupdate.getNotice_complite() %></td>
					              </tr>
					              <tr>
					                <th>제목</th>
					                <td colspan="2">
					                  <input class="form-controltext" id="helpsubject" name="helpsubject" value="<%=noticeupdate.getNotice_subject()%>">
					                </td>
					              </tr>
					              <tr>
					                <th colspan="3">
					                <!-- SE2 -->
										<textarea name="ir1" id="ir1" rows="10" cols="100" style="width:100%; height:412px; display:none;"><%=noticeupdate.getNotice_content() %></textarea>
					                </th>
					              </tr>
					            </thead>
                            </table>
