...
<div id="page-wrapper">
	...
	<form id="department" name="department" method="post" >
		<input type="hidden" id="act" name="act" value="write">
	<!-- /.row -->
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">부서 일정</div>
				<div>
                                                ...
                                                <div class="modal-content">
							                    	...
							                    	일
														...
														<div class="modal-footer">
                                                  	 	<button type="submit" class="btn btn-primary" id="scheduleDwrite">등록</button>&nbsp;&nbsp;&nbsp;
	...
	<!-- Big Calendar -->
	<script type="text/javascript" src="<%=root%>/js/user_schedule/schedule_department.js"></script>
	...
	$("#scheduleDwrite").click(function () {
		if(document.getElementById("schedule_subject").value=="") {
			...
			document.department.action="<%=root%>/schedule_department";
            $("#department").submit();
		}
	});
