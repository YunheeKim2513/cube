...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">회사 일정</div>
				<div>
                                                ...
                                                <div class="modal-content">
							                    	...
							                    	일
														...
														<div class="modal-footer">
                                                  	 	<button type="submit" class="btn btn-primary" id="scheduleCwrite">등록</button>&nbsp;&nbsp;&nbsp;
	...
	<!-- Big Calendar -->
	<script type="text/javascript" src="<%=root%>/js/user_schedule/schedule_company.js"></script>
	...
	$("#scheduleCwrite").click(function () {
		if(document.getElementById("schedule_subject").value=="") {
			...
			document.company.action="<%=root%>/schedule_company";
            $("#company").submit();
		}
	});
	</script>
