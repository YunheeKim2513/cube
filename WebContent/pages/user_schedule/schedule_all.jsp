...
<div id="page-wrapper">
	...
	<form id="all" name="all" method="post" >
		<input type="hidden" id="act" name="act" value="write">
	<!-- /.row -->
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">전체 일정</div>
				<div>
                                        ...
                                        <div class="modal fade" id="schedulewrite" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
													...
													for(int x=year+10; x>=year-20; x--) {
														if(x==year) {%>
													<option selected="<%=year %>" value="<%=x %>"><%=x %></option>
													<%	} else {%>
													<option value="<%=x %>"><%=x %></option>
													<%	}
													} %>
                                           ...
                                           <div class="modal fade" id="participant" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                  	 	<button type="submit" class="btn btn-primary" id="" >등록</button>&nbsp;&nbsp;&nbsp;
												       <button type="button" class="btn btn-primary" data-dismiss="modal">취소</button>
												    </div>
                                                </div>
                                                </div>
	...
	<!-- Big Calendar -->
	<script type="text/javascript" src="<%=root%>/js/user_schedule/schedule_all.js"></script>
	...
	<script type="text/javascript">
	 $("#btnExpandAll").click(function () {
		if(document.getElementById("schedule_subject").value=="") {
			...
			document.all.action="<%=root%>/schedule_all";
            $("#all").submit();
		}
	});
	</script>
