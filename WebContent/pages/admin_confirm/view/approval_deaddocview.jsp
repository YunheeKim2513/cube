        ...
        <!-- /#page-wrapper -->
            ...
            <div class="row">
				<div class="col-lg-12">
	                    ...
	                    <!--     <button type="button" id="updatebtn" name="updatebtn" class="btn btn-primary" style="margin-bottom:7px" onclick="javascript:approvalupdates('<%--=deaddocDto.getDoc_seq()--%>','<%--=deaddocDto.getDoc_name()--%>');">수정</button>
	                        <button type="button" id="deletebtn" name="deletebtn" class="btn btn-primary" style="margin-bottom:7px" onclick="javascript:approvaldelete('<%--=deaddocDto.getDoc_seq()--%>','vacdoc');">삭제</button> -->
                        </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
