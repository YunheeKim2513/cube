...
<body>
<form id="euForm" name="euForm" method="post" value="">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <table align="center">
                        	...
                        	<tr align="center"><td><h2>사원 정보 수정 완료</h2></td></tr>
                        	<tr align="center"><td><font color="white">.</font></td></tr>
                        	<tr align="center"><td><font color="white">.</font></td></tr>
                        	<tr align="center"><td><font color="white">.</font></td></tr>
                        	<tr align="center">
                        		<td align="center">
                        			<input type="button" value="Mypage" onclick="javascript:emplist();">
                        		</td>
                        	</tr>
                        	<tr align="center"><td><font color="white">.</font></td></tr>
                        	<tr align="center"><td><font color="white">.</font></td></tr>
    ...
    function emplist(){
    	document.location.href="<%=root%>/mypage?act=gomypage";
    }
    </script>
