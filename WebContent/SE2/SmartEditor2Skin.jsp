...
<script type="text/javascript" src="<%=root %>/SE2/js/SE2B_Configuration_Service.js" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="<%=root %>/SE2/js/SE2B_Configuration_General.js" charset="utf-8"></script>	<!-- 설정 파일 -->
